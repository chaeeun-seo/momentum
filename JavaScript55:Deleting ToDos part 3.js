...
// we want to keep toDo whose id is not equals to li's id
// id of li is string and id of toDo is number
// parseInt(li.id) to take string and make it into number
